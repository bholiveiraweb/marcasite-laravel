...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 px-4">
            <div class="card">
                <div class="card-header">{{ __('form.title', ['title' => 'Cadastrar Usuário']) }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('form.password_confirmation') }}</label>
