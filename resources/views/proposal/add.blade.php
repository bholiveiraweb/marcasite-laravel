        ...
        <div class="col-md-12 px-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('proposal.store') }}" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="form-group row">
                            <label for="autocomplete" class="col-md-4 col-form-label text-md-right">{{ __('Cliente') }}</label>

                            <div class="col-md-6">
                                <input id="autocomplete" type="text" class="form-control" name="autocomplete" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="constructions_address" type="text" class="form-control @error('constructions_address') is-invalid @enderror" name="constructions_address" value="{{ old('constructions_address') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="proposal_total" type="text" class="form-control @error('proposal_total') is-invalid @enderror" name="proposal_total" value="{{ old('proposal_total') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="entry_amount" type="text" class="form-control @error('entry_amount') is-invalid @enderror" name="entry_amount" value="{{ old('entry_amount') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="installment_qty" type="text" class="form-control @error('installment_qty') is-invalid @enderror" name="installment_qty" value="{{ old('installment_qty') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="installment_amount" type="text" class="form-control @error('installment_amount') is-invalid @enderror" name="installment_amount" value="{{ old('installment_amount') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="payment_starts" type="date" class="form-control @error('payment_starts') is-invalid @enderror" name="payment_starts" value="{{ old('payment_starts') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="installment_date" type="text" class="form-control @error('installment_date') is-invalid @enderror" name="installment_date" value="{{ old('installment_date') }}" required>
