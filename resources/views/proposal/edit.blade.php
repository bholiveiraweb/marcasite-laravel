                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('proposal.update', ['id' => $proposal->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="file" type="file" class="form-control @error('file') is-invalid @enderror" name="file" accept="application/pdf|application/msword">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="status" class="form-control @error('file') is-invalid @enderror">
                                    <option value="0" {{ $proposal->status == 0 ? 'selected' : '' }}>Aberta</option>
                                    <option value="1" {{ $proposal->status == 1 ? 'selected' : '' }}>Fechada</option>
                                </select>
